    ...
    const wxPoint& pos, const wxSize& size, long style, const wxString &name)
{
    ...
    m_text_ctrl = new wxTextCtrl(page_2, TXT_CTRL, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE|wxTE_RICH2);
    ...
    m_radioBtn__sizer = new wxRadioButton(page_4, wxID_ANY, "Radio", wxDefaultPosition, wxDefaultSize, wxRB_SINGLE);
    ...
    auto* rbnPanel = new wxRibbonPanel(rbnPage, wxID_ANY, "English", wxue_img::bundle_english_png().GetBitmap(wxDefaultSize));
    ...
    auto* rbnPanel_2 = new wxRibbonPanel(rbnPage, wxID_ANY, "French", wxue_img::bundle_french_png().GetBitmap(wxDefaultSize));
    ...
    auto* rbnBtnBar = new wxRibbonButtonBar(ribbonPanel2, wxID_ANY);
    {
        ...
        rbnBtnBar->AddButton(wxID_ANY, "Backward", wxue_img::bundle_left_png().GetBitmap(wxDefaultSize), wxEmptyString,
            wxRIBBON_BUTTON_NORMAL);
    }
    rbnBtnBar->Realize();
    ...
    {
        rbnGallery->Append(wxue_img::bundle_toggle_button_png().GetBitmap(wxDefaultSize), wxID_ANY);
    }
    rbnGallery->Realize();
