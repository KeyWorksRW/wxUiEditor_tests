...
..\wxUiEditor\build\bin\%BUILD_TYPE%\wxUiEditor.exe --gen_coverage wxUiTesting.wxui
copy /Y wxUiTesting.log results.log >nul
...
@REM if defined RUN_CODE (
    @REM cmd /c code -r ..\wxUiTesting\results.log
@REM )
