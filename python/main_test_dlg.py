...
class MainTestDialog(wx.Dialog):
    def __init__(self, parent, id=DLG_MAINTEST, title="Main Testing Dialog",
        ...
        self.richText.SetMinSize(self.FromDIP(wx.Size(300, 75)))
        ...
        self.scintilla.SetMinSize(self.FromDIP(wx.Size(300, 150)))
        ...
        self.htmlWin.SetMinSize(self.FromDIP(wx.Size(200, 150)))
        ...
        static_line = wx.StaticLine(page_4, wx.ID_ANY, wx.DefaultPosition,
            self.FromDIP(wx.Size(40, -1)), wx.LI_HORIZONTAL)
        ...
        _box_sizer2 = wx.BoxSizer(wx.VERTICAL)

        staticText2 = wx.StaticText(page_5, wx.ID_ANY, "wxSimpleHtmlLiseBox")
        _box_sizer2.Add(staticText2, wx.SizerFlags().Expand().Border(wx.ALL))
        ...
        self.html_listbox.SetMinSize(self.FromDIP(wx.Size(-1, 100)))
        _box_sizer2.Add(self.html_listbox, wx.SizerFlags(1).Expand().Border(wx.ALL))

        flex_grid_sizer.Add(_box_sizer2, wx.SizerFlags().Border(wx.ALL))
        ...
        # You can only use C++ lambda functions as an event handler C++ code.
